package com.example.kafkapublisherconsumer.config;
...
public class KafkaConsumeConfiguration {
    ...
    public ConsumerFactory<String, String> consumerFactory(){
        ...
        configs.put(ConsumerConfig.GROUP_ID_CONFIG,"javastring");
    ...
    public ConsumerFactory<String, User> userConsumerFactory(){
        ...
        configs.put(ConsumerConfig.GROUP_ID_CONFIG,"javajson");
